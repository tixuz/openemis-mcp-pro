...
description: Полный справочник 675 ресурсов OpenEMIS с доступностью HTTP-методов и статусом записи для MCP-сервера чтения и записи (Core 5.10.0).
keywords:
  - OpenEMIS
...
> **675 ресурсов** · **3355 эндпоинтов** · v1.1.0 · OpenEMIS Core 5.10.0
>
