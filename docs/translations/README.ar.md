...
description: openemis-mcp-pro هو خادم MCP للقراءة والكتابة الذي يربط مساعدي الذكاء الاصطناعي بنظام إدارة المدارس OpenEMIS — 678 مورداً، 3361 نقطة نهاية، 40 دليل إجراءات.
keywords:
  - OpenEMIS
  - نظام إدارة المدارس
  - إدارة التعليم
...
واجهة برمجة التطبيقات REST الأساسية لـ OpenEMIS كبيرة — حيث تعرض واجهة v5 وحدها **3,361 نقطة نهاية عبر 678 موردًا** (Core 5.13.0). لا يمكن لأي وكيل ذكي استيعاب ذلك في السياق، كما أن الاستبطان الخام على طراز Swagger يغمر المحادثة بضوضاء ليس لها علاقة بسؤال المستخدم الفعلي.
...
- [مرجع الموارد](docs/resources.md) — جميع الموارد الـ 678 مع توفر طريقة HTTP وحالة الكتابة (Core 5.13.0)
