...
description: openemis-mcp-pro एक MCP सर्वर है जो AI असिस्टेंट को OpenEMIS स्कूल प्रबंधन प्रणाली से जोड़ता है — 678 संसाधन, 3361 एंडपॉइंट, 40 प्लेबुक्स।
keywords:
  - OpenEMIS
...
OpenEMIS Core REST API बड़ी है — केवल v5 सतह ही **678 संसाधनों में 3,361 एंडपॉइंट्स** (Core 5.13.0) एक्सपोज़ करती है। कोई भी AI एजेंट उसे कॉन्टेक्स्ट में नहीं रख सकता, और कच्ची Swagger-शैली की आत्मनिरीक्षण उस शोर से बातचीत को भर देती है जिसका उपयोगकर्ता के वास्तविक प्रश्न से कोई लेना-देना नहीं है।
...
- [संसाधन संदर्भ](docs/resources.md) — HTTP विधि उपलब्धता और लिखने की स्थिति के साथ सभी 678 संसाधन (Core 5.13.0)
...
| पढ़ने के टूल (सभी 678 संसाधन, Core 5.13.0) | ✅ | ✅ | ✅ | ✅ |
