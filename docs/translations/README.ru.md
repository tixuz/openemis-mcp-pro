...
description: openemis-mcp-pro — MCP-сервер чтения и записи, который подключает ИИ-ассистентов к школьной информационной системе OpenEMIS — 675 ресурсов, 3355 эндпоинтов, 40 плейбуков.
keywords:
  - OpenEMIS
