---
title: عرض الملف الشخصي الكامل لأحد أعضاء الهيئة التدريسية في OpenEMIS
description: يشرح هذا الدليل الإجرائي لـ OpenEMIS كيفية استرجاع الملف الشخصي الكامل لموظف بما يشمل التاريخ الوظيفي والمؤهلات والمناصب من نظام إدارة المدارس.
keywords:
  - OpenEMIS
  - نظام إدارة المدارس
  - إدارة التعليم
...
# عرض الملف الشخصي الكامل لأحد أعضاء الهيئة التدريسية في OpenEMIS
