---
title: Просмотр полного профиля класса в OpenEMIS
description: Этот плейбук OpenEMIS объясняет, как получить полный профиль класса, включая учеников, список преподавателей и распределение предметов из школьной информационной системы.
keywords:
  - OpenEMIS
...
# Просмотр полного профиля класса в OpenEMIS
