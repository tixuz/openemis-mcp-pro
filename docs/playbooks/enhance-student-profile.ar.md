---
title: تعزيز ملف الطالب في OpenEMIS
description: يشرح هذا الدليل الإجرائي لـ OpenEMIS كيفية إضافة أو تحديث معلومات الاتصال والجنسية والاحتياجات الخاصة في سجل الطالب في نظام إدارة المدارس.
keywords:
  - OpenEMIS
  - نظام إدارة المدارس
  - إدارة التعليم
...
# تعزيز ملف الطالب في OpenEMIS بجهات الاتصال والجنسية والاحتياجات الخاصة
