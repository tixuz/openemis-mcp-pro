---
title: عرض الملف الشخصي الكامل للصف في OpenEMIS
description: يشرح هذا الدليل الإجرائي لـ OpenEMIS كيفية استرجاع الملف الشخصي الكامل للصف بما يشمل الطلاب وقائمة المعلمين وتوزيع المواد من نظام إدارة المدارس.
keywords:
  - OpenEMIS
  - نظام إدارة المدارس
  - إدارة التعليم
...
# عرض الملف الشخصي الكامل للصف في OpenEMIS
