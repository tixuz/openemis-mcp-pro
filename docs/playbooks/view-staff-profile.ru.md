---
title: Просмотр полного профиля сотрудника в OpenEMIS
description: Этот плейбук OpenEMIS объясняет, как получить полный профиль сотрудника, включая историю трудоустройства, квалификации и должности из школьной информационной системы.
keywords:
  - OpenEMIS
...
# Просмотр полного профиля сотрудника в OpenEMIS
