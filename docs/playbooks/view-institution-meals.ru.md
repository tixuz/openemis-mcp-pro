---
title: Просмотр программ питания учреждения в OpenEMIS
description: Этот плейбук OpenEMIS объясняет, как получить информацию о программах питания и участии учеников в учреждении из школьной информационной системы.
keywords:
  - OpenEMIS
...
# Просмотр программ питания учреждения в OpenEMIS и участия учеников
