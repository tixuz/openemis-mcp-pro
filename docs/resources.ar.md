---
title: OpenEMIS MCP Pro — مرجع الموارد لإدارة التعليم
description: مرجع كامل بجميع موارد OpenEMIS الـ 678 مع توفر طرق HTTP وحالة الكتابة لخادم MCP للقراءة والكتابة (Core 5.13.0).
keywords:
  - OpenEMIS
  - نظام إدارة المدارس
  - إدارة التعليم
...
# OpenEMIS MCP Pro — مرجع الموارد لإدارة التعليم

> **678 موردًا** · **3361 نقطة نهاية** · v1.2.0 · OpenEMIS Core 5.13.0
>
...
| **── Task* ──** | | | | | | |
| `task-failures` | Task* | ✅ | — | — | — | — (للقراءة فقط) |
| `task-jobs` | Task* | ✅ | — | — | — | — (للقراءة فقط) |
| **── موارد فردية ──** | | | | | | |
