...
description: पढ़ने और लिखने के MCP सर्वर के लिए HTTP विधि उपलब्धता और लेखन स्थिति के साथ OpenEMIS के सभी 678 संसाधनों का पूर्ण संदर्भ (Core 5.13.0)।
keywords:
  - OpenEMIS
...
> **678 संसाधन** · **3361 एंडपॉइंट** · v1.2.0 · OpenEMIS Core 5.13.0
>
...
| **── Task* ──** | | | | | | |
| `task-failures` | Task* | ✅ | — | — | — | — (केवल पठन) |
| `task-jobs` | Task* | ✅ | — | — | — | — (केवल पठन) |
| **── singletons ──** | | | | | | |
